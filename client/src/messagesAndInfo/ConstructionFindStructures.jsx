    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="upper_construction_message">
            The <span className="sorry_label toggle_on">Find Structures</span>
            feature is in development and is not yet ready for use. This feature will be coming soon. Please check back again. This site is frequently updated.
          </div>
          <div className="middle_construction_message">
            When available, this feature will allow the you to identify unknown chords or scales that you are playing by inputting them on the neck. It will identify chords and scales as well a provide alternative options and suggestions for related structures. Updates will be coming soon.
          </div>
