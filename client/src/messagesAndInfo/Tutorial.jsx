    ...
    >
      ...
      >
        ...
        >
          ...
          <div>When a <span className="chord1Tutorial">chord is selected</span>, a "Lock" toggle will appear on the chord card. If the user clicks this toggle, it will <span className="toggle_on">Lock</span> the chord and allow for a <span className="chord2Tutorial">second chord</span> to be <span className="chord2Tutorial">selected</span>. The notes of the <span className="chord2Tutorial">second chord</span> will also be <span className="chord2Tutorial">highlighted</span> on the neck and in the scale display. The remaining notes that do not belong to either chord will automatically be hidden. If the two chords share notes, the <span className="sharedNoteTutorial">Shared Notes</span> indicator will <span className="sharedNoteTutorial">glow</span> in the upper right corner and the note names of the <span className="sharedNoteTutorial">shared notes</span> inside the chord cards and in the scale display will also <span className="sharedNoteTutorial">glow</span>. The <span className="sharedNoteTutorial">shared notes</span> will be <span className="sharedNoteTutorial">highlighted</span> on the neck. Click on the current <span className="chord2Tutorial">second chord</span> to clear the <span className="chord2Tutorial">second chord</span> selection. The <span className="toggle_on">Locked</span> chord can be unlocked by clicking the toggle again. Both chord selections can be cleared by clicking the <span className="toggle_on">Locked</span> <span className="chord1Tutorial">chord</span>. </div>
          <div>Any alterations made to either chord will be immediately reflected in the neck display, scale display, and chord cards.(see section on <a href="#alter_chords">Alterations</a>) <a href="#top">Back to Top</a></div>
